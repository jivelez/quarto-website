...
<!-- - **Premio a la Excelencia Docente** [Teaching Excellence Award], Universidad del Norte, Noviembre 13, 2024. This recognition is awarded to the top-rated permanent lecturer and professor in each department, based on student teaching evaluations. -->

<!-- ocupar el sexto puesto en el listado de profesores con mayor cantidad -->
<!-- de citas en los últimos 5 años SCOPUS, el octavo puesto en el listado de profesores con mayor -->
<!-- cantidad de citas en total Google Scholar, el tercer puesto en el listado profesores con mayor -->
<!-- H-index en los últimos 5 años SCOPUS, el mayor H-index en los últimos 5 años scopus en su -->
<!-- división, el octavo puesto en el listado profesores con mayor H-index en total Google Scholar -->
<!-- y el mayor H-index en total Google Scholar en su división. -->
