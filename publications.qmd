...
I have an established publication record in ISI/SCOPUS top-tier indexed journals, with `4693` citations according to [Google Scholar](https://scholar.google.com.co/citations?user=GFxNB78AAAAJ&hl=en).
...
1. Juliana Rivera, **Jorge I. Vélez**, Carlos A. Arteta. Data-Driven Zonation for Seismic Exposure Modeling via Machine Learning. <code style="color: green; background-color: #d4edda;">Accepted</code>, [Earthquake Spectra](https://onlinelibrary.wiley.com/journal/19448201).
