...
I have an established publication record in ISI/SCOPUS top-tier indexed journals, with `4637` citations according to [Google Scholar](https://scholar.google.com.co/citations?user=GFxNB78AAAAJ&hl=en).
...
1. Jairo A. Ángel, **Jorge I. Vélez**. Finite-Sample Diagnostics for Random-Effects Misspecification in Poisson Generalized Linear Mixed Models. <code style="color: green; background-color: #d4edda;">To Appear</code>, [Axioms](https://www.mdpi.com/journal/axioms).
