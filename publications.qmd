...
I have an established publication record in ISI/SCOPUS top-tier indexed journals, with `4628` citations according to [Google Scholar](https://scholar.google.com.co/citations?user=GFxNB78AAAAJ&hl=en).
...
1. María I. Mosquera-Heredia, Oscar M. Vidal, Ernesto Barceló, Luis C. Morales, Carlos Silvera-Redondo, Daniel A. Bolívar, Ricardo Allegri, Mauricio Arcos-Burgos, Pilar Garavito-Galofre, **Jorge I. Vélez**. Novel Blood lncRNA Biomarkers Predict Alzheimer’s Disease Severity and Specific Cognitive Dimensions. <code style="color: red; background-color: #f8d7da;">Under Review</code>, _Journal of Alzheimer's disease_.

1. Lilybeth Martinez-Olivares, Ángel Hernández, **Jorge I. Vélez**, Oscar M Vidal. Prostate Cancer, Artificial Intelligence, and Genomic Innovation (2001–2025): Global Bibliometric Analysis and Knowledge Networks with a Latin American Perspective. <code style="color: red; background-color: #f8d7da;">Under Review</code>, _Social Sciences & Humanities Open_.

1. Luis Avila-Lorduy, Vicente Mercado, Juan Jiménez, **Jorge I. Vélez**, Carlos Pacheco. A Robust Machine Learning Framework for Multitemporal Bare Soil Monitoring with High Temporal Transferability. <code style="color: red; background-color: #f8d7da;">Under Review</code>, _Scientific Reports_.

1. Mauro González, **Jorge I. Vélez**, Adriana Arango-Manrique. Bayesian SMAP Model for Probabilistic Inflow Forecasting in Hydropower-Based Energy Systems. <code style="color: red; background-color: #f8d7da;">Under Review</code>, _Applied Water Science_.
