...
<!-- I have authored 102 research articles indexed in ISI and SCOPUS,   -->

<!-- I have authored several research articles indexed in ISI and SCOPUS, with additional manuscripts presently under review. These manuscripts have reached `4583` citations according to [Google Scholar](https://scholar.google.com.co/citations?user=GFxNB78AAAAJ&hl=en). -->

<!-- My research portfolio includes numerous articles in top-tier indexed journals (ISI/SCOPUS), supported by a strong citation record of 4,583 per Google Scholar. -->

I maintain an established publication record in ISI and SCOPUS top-tier indexed journals. Selected publications are accessible below or via my academic profiles on [Google Scholar](https://scholar.google.com.co/citations?user=GFxNB78AAAAJ&hl=en), [PubMed](https://pubmed.ncbi.nlm.nih.gov/?term=Velez+JI&filter=years.2007-3000&sort=pubdate), [Research Gate](https://www.researchgate.net/profile/Jorge_Velez13), [SCOPUS](https://www.scopus.com/authid/detail.uri?authorId=24336983600), [ORCID](https://orcid.org/0000-0002-3146-7899), [SciProfiles](https://sciprofiles.com/profile/661921), [WoS ResearcherID](https://www.webofscience.com/wos/author/record/NRB-9285-2025) or <a href="https://scienti.minciencias.gov.co/cvlac/visualizador/generarCurriculoCv.do?cod_rh=0001349639&lang=es" target="_blank"> CvLAC </a>. My AD Scientific Index is <a href="https://www.adscientificindex.com/scientist.php?id=844354" target="_blank"> here</a>.


<!-- ### Research Papers -->


<!-- 1. Mauro González, **Jorge I. Vélez**, Adriana Arango-Manrique. Shape-Preserving Minimum Trace (SP-MinT): A Regularized Forecast Reconciliation Method for Hierarchical Time Series. <code style="color: red; background-color: #f8d7da;">Under Review</code>, _Scientific Reports_. -->


<!-- ## Submitted -->

<!-- 1. Maria I. Arrieta-Escobar, Carlos D. Paternina-Arboleda, **Jorge I. Vélez**, Guisselle A. García-Llinás. Enhancing Agricultural Decision-Making: Banana Yield Forecasting in Colombia Using Tuned Ensemble Machine Learning Models. <code style="color: #856404; background-color: #fff3cd;">Submitted</code>, _AgriEngineering_. -->

<!-- 2. Jairo Ángel, **Jorge I. Vélez**, Freddy Hernández. G-CuT: A Symmetrized Information-Matrix Diagnostic for Multinomial GLMMs. <code style="color: #856404; background-color: #fff3cd;">Submitted</code>, _Applied Mathematical Modelling_. -->

<!-- 3. Julián Ramírez-Cheyne, César Payán-Gómez, Diana López, **Jorge I. Vélez**, Wilmar Saldarriaga, Mauricio Arcos-Burgos. Fragile X Syndrome in the Largest World Clustering: II. Autosomal and Common Genetic Variation Underpinning Seizures, FXTAS, and FXPOI. <code style="color: #856404; background-color: #fff3cd;">Submitted</code>, _American Journal of Medical Genetics, Part A_. -->

<!-- 4. Sonia Moreno, Felipe Gutiérrez, Shelly Langebeck, Sergio V. Flores, Jennie Erin Smith, Francisco Lopera, **Jorge I. Vélez**, Mauricio Arcos-Burgos. Four Decades of Neuropsychiatric Genetics in Colombia: Founder Effects, Gene Flow, and Geographical Mapping. <code style="color: #856404; background-color: #fff3cd;">Submitted</code>, _American Journal of Medical Genetics, Part B_. -->

<!-- 1. Lilybeth Martinez-Olivares, Ángel Hernández, **Jorge I. Vélez**, Oscar M Vidal. Prostate Cancer, Artificial Intelligence, and Genomic Innovation (2001–2025): Global Bibliometric Analysis and Knowledge Networks with a Latin American Perspective. <code style="color: #856404; background-color: #fff3cd;">Submitted</code>, _Social Sciences & Humanities Open_. -->

<!-- 1. Luis Avila-Lorduy, Vicente Mercado, Juan Jiménez, **Jorge I. Vélez**, Carlos Pacheco. A Robust Machine Learning Framework for Multitemporal Bare Soil Monitoring with High Temporal Transferability. <code style="color: #856404; background-color: #fff3cd;">Submitted</code>, _Scientific Reports_. -->

<!-- 1. Mauro González, **Jorge I. Vélez**, Adriana Arango-Manrique. Bayesian SMAP Model for Probabilistic Inflow Forecasting in Hydropower-Based Energy Systems. <code style="color: #856404; background-color: #fff3cd;">Submitted</code>, _Applied Water Science_. -->

<!-- 1. Mauro González, **Jorge I. Vélez**, Adriana Arango-Manrique. Shape-Preserving Minimum Trace (SP-MinT): A Regularized Forecast Reconciliation Method for Hierarchical Time Series. <code style="color: #856404; background-color: #fff3cd;">Submitted</code>, _Scientific Reports_. -->

<!-- ## Accepted for Publication -->

<!-- 1. María I. Mosquera-Heredia, Oscar M. Vidal, Ernesto Barceló, Luis C. Morales, Carlos Silvera-Redondo, Daniel A. Bolívar, Ricardo Allegri, Mauricio Arcos-Burgos, Pilar Garavito-Galofre, **Jorge I. Vélez**. Novel Blood lncRNA Biomarkers Predict Alzheimer’s Disease Severity and Specific Cognitive Dimensions. <code style="color: green; background-color: #d4edda;">Accepted</code>, [Journal of Alzheimer's disease](https://journals.sagepub.com/home/ALZ). -->

<!-- ## Published -->

1. Juliana Rivera, **Jorge I. Vélez**, Carlos A. Arteta. Data-Driven Zonation for Seismic Exposure Modeling via Machine Learning.  [Earthquake Spectra](https://onlinelibrary.wiley.com/doi/10.1002/esp4.70089), 2026, _42_(3), e70089.

1. Jairo A. Ángel, **Jorge I. Vélez**. Finite-Sample Diagnostics for Random-Effects Misspecification in Poisson Generalized Linear Mixed Models. [Mathematics](https://doi.org/10.3390/math14122042)  2026, _14_(12), 2042. 

1. Carlos M. Ferreira-Vanegas, Héctor López-Ospina, Juan Pérez, **Jorge I. Vélez**, Guisselle A. García-Llinás. Feature Policy: A hybrid approach to minimize the severity of road crashes through interventions in predictor variables. [Journal of Safety Research](https://doi.org/10.1016/j.jsr.2026.01.006), 96, 2026, pp. 300-314.

1. Ernesto Barceló, Duban Romero, Ricardo Allegri, Eliana Meza, María I. Mosquera-Heredia, Oscar M. Vidal,  Carlos Silvera-Redondo, Mauricio Arcos-Burgos, Pilar Garavito-Galofre and **Jorge I. Vélez**. The ICN-UN Battery: A Machine Learning-Optimized Tool for Expeditious Alzheimer’s Disease Diagnosis. [Diagnostics](https://www.mdpi.com/2075-4418/15/23/3045). 15 (23), 3045, 2025.

1. Keldys D. Sarmiento-Pupo, Jesús D. Escalante-Tovar, Jesús E. Altamiranda, Joaquin Abellan-Garcia, **Jorge I. Vélez**. Predicting Flexural Strength in Fiber-Reinforced UHPC via Random Forest. [Scientific Reports](https://www.nature.com/articles/s41598-025-26138-2). 15 (42045), 2025.

1. Beatriz E. Orozco, Cindy V. Orozco, Esperanza Meléndez, María F. Mangones, José Valderrama, Adalberto Lobato, Pilar Garavito-Galofre, **Jorge I. Vélez**, Oscar M. Vidal. Co-occurrence of _RAD21_ and _TNFAIP3_ Mutations in Cornelia de Lange Syndrome with Pustular Psoriasis: Potential Molecular Interactions.  [International Journal of Molecular Sciences](https://www.mdpi.com/1422-0067/26/21/10783). 26(21), 10783.
