...
I have an established publication record in ISI/SCOPUS top-tier indexed journals, with `4657` citations according to [Google Scholar](https://scholar.google.com.co/citations?user=GFxNB78AAAAJ&hl=en).
...
1. María I. Mosquera-Heredia, Oscar M. Vidal, Ernesto Barceló, Luis C. Morales, Carlos Silvera-Redondo, Daniel A. Bolívar, Ricardo Allegri, Mauricio Arcos-Burgos, Pilar Garavito-Galofre, **Jorge I. Vélez**. Novel Blood lncRNA Biomarkers Predict Alzheimer’s Disease Severity and Specific Cognitive Dimensions. <code style="color: #856404; background-color: #fff3cd;">Under Review</code>, _Journal of Alzheimer's disease_.
...
1. Jairo A. Ángel, **Jorge I. Vélez**. Finite-Sample Diagnostics for Random-Effects Misspecification in Poisson Generalized Linear Mixed Models. <code style="color: green; background-color: #d4edda;">To Appear</code>, [Mathematics](https://www.mdpi.com/journal/mathematics).
